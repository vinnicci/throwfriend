...
/// </summary>
[Tool]
public class Twisted_ModifierJiggle2D : Twisted_Modifier2D
{
    /// <summary>
    ...
    public override object _Get(string property)
    {
        if (property == "Jiggle/target") {
            ...
            if (jiggle_data[3] == "twisted_bone") {
                ...
                return Mathf.Rad2Deg(jiggle_joints[joint_index].additional_rotation);
            }
        }
    ...
    private void _ExecuteJoint(int joint_id, Twisted_ModifierStack2D modifier_stack, float delta) {
        ...
        if (use_colliders == true && execution_mode == TWISTED_IK_MODIFIER_MODES_2D._PHYSICS_PROCESS) {
            ...
            Physics2DDirectSpaceState space_state = world_2d.DirectSpaceState;
            
            Godot.Collections.Dictionary result = space_state.IntersectRay(
                current_joint.twisted_bone.GlobalTransform.origin, dynamic_trans_in_world.origin,
