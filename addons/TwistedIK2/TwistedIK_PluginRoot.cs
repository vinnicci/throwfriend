...
[Tool]
public class TwistedIK_PluginRoot : EditorPlugin
{
    public override void _EnterTree() {
        ...
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_3D/Twisted_Skeleton3D.png");
        AddCustomType("Twisted_Skeleton3D", "Spatial", node_script, node_texture);
        
        node_script = GD.Load<Script>("res://addons/TwistedIK2/IK_3D/Twisted_Bone3D.cs");
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_3D/Twisted_Bone3D.png");
        AddCustomType("Twisted_Bone3D", "Spatial", node_script, node_texture);

        node_script = GD.Load<Script>("res://addons/TwistedIK2/IK_3D/Twisted_Modifier3D.cs");
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_3D/Twisted_Modifier3D.png");
        AddCustomType("Twisted_Modifier3D", "Spatial", node_script, node_texture);

        node_script = GD.Load<Script>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierStack3D.cs");
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierStack3D.png");
        AddCustomType("Twisted_ModifierStack3D", "Spatial", node_script, node_texture);

        node_script = GD.Load<Script>("res://addons/TwistedIK2/IK_3D/Twisted_PhysicsBone3D.cs");
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_3D/Twisted_PhysicsBone3D.png");
        AddCustomType("Twisted_PhysicsBone3D", "RigidBody", node_script, node_texture);

        // ======= 3D MODIFIERS
        node_script = GD.Load<Script>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierLookAt3D.cs");
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierLookAt3D.png");
        AddCustomType("Twisted_ModifierLookAt3D", "Spatial", node_script, node_texture);

        node_script = GD.Load<Script>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierCCDIK3D.cs");
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierCCDIK3D.png");
        AddCustomType("Twisted_ModifierCCDIK3D", "Spatial", node_script, node_texture);

        node_script = GD.Load<Script>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierFABRIK3D.cs");
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierFABRIK3D.png");
        AddCustomType("Twisted_ModifierFABRIK3D", "Spatial", node_script, node_texture);

        node_script = GD.Load<Script>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierJiggle3D.cs");
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierJiggle3D.png");
        AddCustomType("Twisted_ModifierJiggle3D", "Spatial", node_script, node_texture);

        node_script = GD.Load<Script>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierTwoBoneIK3D.cs");
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierTwoBoneIK3D.png");
        AddCustomType("Twisted_ModifierTwoBoneIK3D", "Spatial", node_script, node_texture);

        node_script = GD.Load<Script>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierCurveIK3D.cs");
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierCurveIK3D.png");
        AddCustomType("Twisted_ModifierCurveIK3D", "Spatial", node_script, node_texture);

        node_script = GD.Load<Script>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierSliderJoint3D.cs");
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_3D/Twisted_ModifierSliderJoint3D.png");
        AddCustomType("Twisted_ModifierSliderJoint3D", "Spatial", node_script, node_texture);
        ...
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_3D/Twisted_PhysicsBoneMotor3D.png");
        AddCustomType("Twisted_PhysicsBoneMotor3D", "Spatial", node_script, node_texture);

        // ======= 2D NODES
        node_script = GD.Load<Script>("res://addons/TwistedIK2/IK_2D/Twisted_Bone2D.cs");
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_2D/Twisted_Bone2D.png");
        ...
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_2D/Twisted_Modifier2D.png");
        ...
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_2D/Twisted_ModifierStack2D.png");
        ...
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_2D/Twisted_PhysicsBone2D.png");
        ...
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_2D/Twisted_ModifierLookAt2D.png");
        ...
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_2D/Twisted_ModifierCCDIK2D.png");
        ...
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_2D/Twisted_ModifierFABRIK2D.png");
        ...
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_2D/Twisted_ModifierJiggle2D.png");
        ...
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_2D/Twisted_ModifierCurveIK2D.png");
        ...
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_2D/Twisted_ModifierTwoBoneIK2D.png");
        ...
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_2D/Twisted_ModifierSliderJoint2D.png");
        ...
        node_texture = GD.Load<Texture>("res://addons/TwistedIK2/IK_2D/Twisted_PhysicsBoneMotor2D.png");
